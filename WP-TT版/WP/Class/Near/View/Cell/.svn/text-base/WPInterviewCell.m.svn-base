...
@implementation WPInterviewCell
...
{
    static NSString *cellId = @"WPInterviewCell";
    WPInterviewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellId forIndexPath:indexPath];
    return cell;
}
...
-(void)setModel:(WPInterviewListModel *)model
{
    ...
    self.titleLabel.text = model.HopePosition;
