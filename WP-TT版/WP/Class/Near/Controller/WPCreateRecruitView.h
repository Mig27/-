...
typedef NS_ENUM(NSInteger,WPCreateRecruitViewType){
    WPRecruitApplyViewTypeLightspot,
    WPRecruitApplyViewTypeEducationList,
    WPRecruitApplyViewTypeWorkList
};

typedef NS_ENUM(NSInteger,WPCreateRecruitViewActionType) {
    /** 姓名 */
...
@interface WPCreateRecruitView : UIView
...
@property (nonatomic, copy) void (^RecruitApplyViewBlock)(WPCreateRecruitViewType type);
