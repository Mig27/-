...
@implementation WPDontSeeWorkShopHttp
...
+ (void)WPDontSeeWorkShopHttpWithParam:(WPDontSeeWorkShopParam *)param success:(void (^)(WPDontSeeWorkShopResult *result))success failure:(void (^)(NSError *error))failure{
    ...
    [mgr POST:url parameters:parame success:^(AFHTTPRequestOperation *operation, id responseObject) {
        WPDontSeeWorkShopResult *result = [WPDontSeeWorkShopResult mj_objectWithKeyValues:responseObject];
