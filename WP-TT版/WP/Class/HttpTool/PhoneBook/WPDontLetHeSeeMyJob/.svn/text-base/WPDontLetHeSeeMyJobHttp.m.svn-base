...
@implementation WPDontLetHeSeeMyJobHttp
...
+ (void)WPDontLetHeSeeMyJobHttpWithParam:(WPDontLetHeSeeMyJobParam *)param success:(void (^)(WPDontLetHeSeeMyJobResult *result))success failure:(void (^)(NSError *error))failure{
    ...
    [mgr POST:url parameters:parame success:^(AFHTTPRequestOperation *operation, id responseObject) {
        WPDontLetHeSeeMyJobResult *result = [WPDontLetHeSeeMyJobResult mj_objectWithKeyValues:responseObject];
