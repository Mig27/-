...
@implementation WPDontLetHeSeeMyRecruitHttp
...
+ (void)WPDontLetHeSeeMyRecruitHttpWithParam:(WPDontLetHeSeeMyRecruitParam *)param success:(void (^)(WPDontLetHeSeeMyRecruitResult *result))success failure:(void (^)(NSError *error))failure{
    ...
    [mgr POST:url parameters:parame success:^(AFHTTPRequestOperation *operation, id responseObject) {
        WPDontLetHeSeeMyRecruitResult *result = [WPDontLetHeSeeMyRecruitResult mj_objectWithKeyValues:responseObject];
