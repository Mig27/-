...
@interface WPSearchViewController () <UITextFieldDelegate, UISearchBarDelegate, UISearchDisplayDelegate, UITabBarDelegate, UITableViewDataSource,UITableViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource,WPActionSheet,UISelectDelegate,WPInterviewControllerDelegate,WPRecuilistControllerDelegate>
...
- (UIScrollView*)scrollViewFirst
{
    if (_scrollViewFirst == nil) {
        ...
        NSArray* arrayButtonName = @[@"行业", @"职称", @"经验",@"学历",@"福利",@"年龄", @"性别"];
...
-(void)tableView:(NSIndexPath *)indexPath
{
    ...
    //vc.type = WPNearPersonalTypeActivity;
    //if (_isRecruit) {
        //switch (_bottomType) {
            //case 0:
