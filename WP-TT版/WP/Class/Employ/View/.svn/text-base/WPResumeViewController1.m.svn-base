...
#import "WPResumeViewController1.h"

@interface WPResumeViewController1 ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation WPResumeViewController1
