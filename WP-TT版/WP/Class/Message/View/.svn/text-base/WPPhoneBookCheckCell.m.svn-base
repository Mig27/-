...
@interface WPPhoneBookCheckCell()<UITextFieldDelegate>
...
@implementation WPPhoneBookCheckCell
...
- (void)setTitle:(NSString *)title
{
    ...
    if (_needSelect) {  //  根据这个属性来判断是否展示复选框
...
{
    [self.superview endEditing:YES]; //  当选中的时候收起键盘
