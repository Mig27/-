...
////1. 用来存储对应的数组个数
//- (void) changeDataArrCountAndChangeContentSize{
//    if (dataArrCount != self.data.count) {
//        dataArrCount = self.data.count;
//        i = 0;
...
//        //dosomething
//        [self changeDataArrCountAndChangeContentSize];
//    } else {
...
//
//- (void)dealloc{
//    [_tableView removeObserver:self forKeyPath:@"contentSize" context:@"ThisIsMyKVOContextNotSuper"];
//}
...
//        [_tableView addObserver:self forKeyPath:@"contentSize" options:NSKeyValueObservingOptionNew context:@"ThisIsMyKVOContextNotSuper"];
...
//            if (indexPath.row == self.data.count - 1 && i == 0) {
//                i = 1;
