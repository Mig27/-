...
{
    return IM_GROU_MEMBER_CHANGED;//IM_GROUP_CHANGE_MEMBER_REQ
}
...
- (UnrequestAPIAnalysis)unrequestAnalysis
{
    ...
    {
        IMGroupChangeMemberNotify*notifi = [IMGroupChangeMemberNotify parseFromData:data];
//        PBArray * array =notifi.chgUserIdList;
        return notifi;
