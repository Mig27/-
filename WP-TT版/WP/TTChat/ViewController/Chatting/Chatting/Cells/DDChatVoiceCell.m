...
//#define maxCellLength 2*CHATH(97);
//#define minCellLength CHATH(20);
    ...
    switch (self.location)
    {
        case DDBubbleLeft:
        {
            ...
            [_timeLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
                ...
                make.bottom.equalTo(self.bubbleImageView.mas_bottom).offset(-8.5);
...
//        return length;
        float length = voiceLength/60*(maxCellLength-minCellLength) + minCellLength;
        return length;
