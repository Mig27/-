...
-(void)initData
{
    ...
    [_avatar sd_setImageWithURL:[NSURL URLWithString:[IPADDRESS stringByAppendingString:[self.user get300AvatarUrl]]] placeholderImage:placeholder];
