...
- (id)initWithScrollView:(UIScrollView *)scrollView {
    ...
    if (self =[super initWithFrame:CGRectZero]) {
        ...
        self.titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 200, 20)];//20
    ...
    if (self.pullToRefreshHandler) {
        switch (theState) {
            ...
            case DDPullToRefreshStateNomore:{
                ...
                if (isScrollInFrame && offsetY<-MTTRefreshViewHeight) {
                    [self.scrollView setContentOffset:CGPointMake(0, -MTTRefreshViewHeight) animated:YES];//-self.scrollView.contentInset.top
                }
            }
                break;
