...
//    __unsafe_unretained  UILabel *_upLine;
}
/** 所有状态对应的文字 */
...
//{
//    if (!_upLine) {
////        [self addSubview:_upLine = [UILabel label]];
//    }
//    return _upLine;
//}
...
- (void)prepare
{
    ...
    // 初始化文字
    [self setTitle:MJRefreshHeaderRefreshingText forState:MJRefreshStateIdle];
...
- (void)placeSubviews
{
    ...
    if (self.lastUpdatedTimeLabel.hidden) {
        ...
        if (noConstrainsOnStatusLabel) {
            ...
            self.stateLabel.mj_h = self.mj_h;//stateLabelH
        }
...
//        if (noConstrainsOnStatusLabel) {
//            self.upLine.mj_x = 0;
//            self.upLine.mj_y = self.mj_h-0.5;
//            self.upLine.mj_w = self.mj_w;
//            self.upLine.mj_h = 0.5;
//            self.upLine.backgroundColor = [UIColor colorWithRed:226/255.0 green:226/255.0 blue:226/255.0 alpha:1.0];
//        }
    }
}
