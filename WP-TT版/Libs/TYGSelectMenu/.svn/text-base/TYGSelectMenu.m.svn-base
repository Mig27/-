...
- (UIView *)drawShowViewWithFrame:(CGRect)frame{
    ...
    CGFloat scrollH = CGRectGetHeight(mainView.frame) - scrollY - 64;
...
//        tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
        ...
        if (i == 0) {
            UIControl *control = [[UIControl alloc] initWithFrame:CGRectMake(0, tableView.bottom, SCREEN_WIDTH, 64)];
            [control addTarget:self action:@selector(onTap) forControlEvents:UIControlEventTouchUpInside];
