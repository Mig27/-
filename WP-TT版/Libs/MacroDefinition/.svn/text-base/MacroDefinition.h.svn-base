...
#define GetBFont(x) [UIFont boldSystemFontOfSize:x]
#define GetHeight(x) x*9/16

//主体颜色
#define DefaultControlColor [UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:1]
